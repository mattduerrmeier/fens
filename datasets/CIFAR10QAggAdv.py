...
class CIFAR10QAggAdv(Dataset):
    def __init__(self, size, args):
        ...
        if not self.args.proxy_set:
            raise ValueError("Proxy set must be specified for CIFARQ10AggAdv")
        if not self.args.logitpath:
            raise ValueError("Logit path must be specified for CIFARQ10AggAdv")
