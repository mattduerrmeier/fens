...
def parse_arguments():
    ...
    parser.add_argument(
        "--epochs", type=int, default=-1, help="Number of epochs; -1 defaults to flamby"
    )
    ...
    parser.add_argument(
        "--lm_epochs", type=int, default=300, help="Linear mapping agg epochs"
    )
    parser.add_argument(
        "--lm_lr", type=float, default=1e-5, help="Linear mapping agg learning rate"
    )
    parser.add_argument(
        "--nn_epochs", type=int, default=300, help="Neural network agg epochs"
    )
    parser.add_argument(
